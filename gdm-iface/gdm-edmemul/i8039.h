 ...
 */
#define I8039_In(Port) ((UINT8)emul_io_read((UINT8)Port))


/*
 *   Output a UINT8 to given I/O port
 */
#define I8039_Out(Port,Value) (emul_io_write((UINT8)Port,(UINT8)Value))


/*
 *   Read a UINT8 from given memory location
 */
#define I8039_RDMEM(A) ((unsigned)emul_rom_read(A))


/*
 *   Write a UINT8 to given memory location
 */
#define I8039_WRMEM(A,V) (while(1);)
 ...
 */
#define I8039_RDOP(A) ((unsigned)emul_rom_read(A))
 ...
 */
#define I8039_RDOP_ARG(A) ((unsigned)emul_rom_read(A))

int     Dasm8039(char *dst, unsigned pc);

void i8039_reset(void *);
int  i8039_execute(int, int);
void i8039_get_context (void *dst);
